...
public class ServerSetting implements SimpleListItem {
	...
	private final boolean useDefaultServerPort;
	...
	public ServerSetting(int key, String name, Daemon type, String address, String localAddress, int localPort, String localNetwork, int port,
						 ...
						 boolean isAutoGenerated, boolean useDefaultServerPort) {
		this.key = key;
		this.name = name;
		this.type = type;
	...
	private DaemonSettings convertToDaemonSettings(String connectedToNetwork, Context caller) {
		...
		return new DaemonSettings(name, type, addressToUse, portToUse, ssl, sslTrustAll, sslTrustKey, folder,
				...
				alarmOnFinishedDownload, alarmOnNewTorrent, Integer.toString(key), isAutoGenerated, useDefaultServerPort);
	}
}
