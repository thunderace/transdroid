...
public final class DaemonSettings {
	...
	final private boolean useDefaultServerPort;
	
	protected DaemonSettings() {
		this(null, null, null, 0, false, false, null, null, false, null, null, null,
				null, null, null, null, 0, false, false, null, false, true);
	}
	...
	public DaemonSettings(String name, Daemon type, String address, int port, boolean ssl, 
			...
			boolean alarmOnFinishedDownload, boolean alarmOnNewTorrent, String idString, boolean isAutoGenerated, boolean useDefaultServerPort)
	{
		this.name = name;
		this.type = type;
		...
		this.useDefaultServerPort = useDefaultServerPort;
	}
	...
	public String getHumanReadableIdentifier() {
		...
		return (this.ssl ? "https://" : "http://")
			+ (this.shouldUseAuthentication() && this.getUsername() != null && this.getUsername() != "" ? this
				.getUsername() + "@" : "") + getAddress() + getPortString()
